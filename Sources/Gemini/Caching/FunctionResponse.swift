/// The result output from a ``FunctionCall`` that contains a string representing the ``FunctionDeclaration/name`` and a structured JSON object
...
public struct FunctionResponse: Codable, Sendable {
    ...
    public init(id: String?, name: String, response: Protobuf.Struct, parts: [Self.Part]? = nil, willContinue: Bool? = nil, scheduling: Scheduling? = nil) {
        self.id = id
        self.name = name
...
extension FunctionResponse {
    ...
    public enum Scheduling: String, Codable, Sendable {
