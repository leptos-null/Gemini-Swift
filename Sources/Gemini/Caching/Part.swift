...
///
/// A `Part` must have a fixed IANA MIME type identifying the type and subtype of the media if the ``Part/Data/inlineData(_:)`` field is filled with raw bytes.
///
...
public struct Part: Sendable {
    ...
    public enum Metadata: Sendable {
        /// Video metadata.
        ///
        /// The metadata should only be specified while the video data is presented in ``Part/Data/inlineData(_:)`` or ``Part/Data/fileData(_:)``.
    ...
    public let thoughtSignature: Protobuf.Bytes?
